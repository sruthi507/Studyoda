    ...
    return (
        <div className=" mb-80 relative mt-24">
            ...
            <div className="container mx-auto lg:max-w-screen-sm my-20">
                <div className="bg-white mx-24 text-center shadow-lg rounded-lg lg:rounded-full flex flex-col lg:flex-row justify-between relative">
                    <div className="cursor-pointer px-6 py-2 my-1 mx-1 font-bold text-base hover:bg-pink-400 hover:text-white hover:mx-1 hover:my-1 hover:border-red-900 hover:rounded-full">
                        Notes
                    </div>
                    <div className="cursor-pointer px-6 py-2 my-1 mx-1 font-bold text-base hover:bg-pink-400 hover:text-white hover:mx-1 hover:my-1 hover:border-red-900 hover:rounded-full">
                        Create Tasks
            ...
            <div className="container mx-auto lg:max-w-screen-xl">
                <div className="flex flex-col lg:flex-row text-center px-10 lg:px-24 space-x-0 lg:space-x-14 space-y-8 lg:space-y-0">
                    <div className="lg:w-1/2 bg-white rounded-xl p-4 relative">
                        ...
                        <div className="flex justify-between items-center px-8 py-4">
                            ...
                            <div className="bg-zinc-100 rounded-full relative p-5">
                                <div className="text-3xl absolute top-1 left-1">
                        ...
                        <div className="mt-2 text-start leading-relaxed">
                            <p className="px-8">
                                ...
                                installed base sources whereas distinctive products.Credibly morph installed Credibly
                                morph installed base sources whereas distinctive products.Credibly morph installed base
                                sources whereas distinctive products.Credibly
                            </p>
                        </div>
                    ...
                    <div className="lg:w-[564px] py-16 lg:py-20 px-0 lg:px-5 text-start space-y-5 pr-0 lg:pr-12">
                        ...
                        <div className="flex items-center space-x-2">
                            <CheckIcon />
                            <p>
                                Click<b> Open Note </b>button here open full note
                            </p>
                        </div>
                        <div className="flex items-center space-x-2">
                            <CheckIcon />
